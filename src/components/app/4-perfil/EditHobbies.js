...
export default function EditHobbies() {
    ...
    const seleccionarTag = () => {
        if (tag.trim()) {
            setListHobbies([...listHobbies, tag.trim()]);
            setTag("");
        }
    }
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.tagsContainer}>
                {listHobbies.map((hobby, index) => (
                    <View key={index} style={styles.tag}>
                        ...
                        <TouchableOpacity onPress={() => eliminarTag(hobby)}>
            ...
            <View style={styles.buttonContainer}>
                <TouchableOpacity
                    style={[styles.button, listHobbies.length === 0 && styles.buttonDisabled]}
                    disabled={listHobbies.length === 0}
